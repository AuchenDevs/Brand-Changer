...
echo.
echo.
echo	[1]. Server.bat (AINSI Colours)
echo 		  _
echo        >(.)__
echo         (___/ C:\Users\craciu25yt>
echo.
echo    [2]. Kali ..
...
echo.
echo    [4]. Default + comillas angulares ..
...
if "%preset%"=="1" (setx prompt $E[38;5;220m$S$S_$_$E[38;5;208m$G$E[38;5;220m$C$E[0m.$E[38;5;220m$F__$_$S$C___/$E[0m$S$P$G$S & goto es-menu)
if "%preset%"=="2" (goto es-PKali)
if "%preset%"=="3" (setx prompt "$T $B $P$g " & goto es-menu)
if "%preset%"=="4" (setx prompt "$P» " & goto es-menu)
if "%preset%"=="5" (goto es-menu)
cls
echo TIENES QUE PONER 1/2/3/4/5. %preset% no es una respuesta valida.
timeout 3 >%temp%/Brand_changer.tmp
goto es-preset
...
echo          2:19:13.96 ^| C:\Users\craciu25yt^>
echo.
echo    [4]. Default + angular quotation marks ..
echo          C:\Users\craciu25yt»
echo.
...
if "%preset%"=="1" (setx prompt $E[38;5;220m$S$S_$_$E[38;5;208m$G$E[38;5;220m$C$E[0m.$E[38;5;220m$F__$_$S$C___/$E[0m$S$P$G$S & goto en-menu)
if "%preset%"=="2" (goto en-PKali)
if "%preset%"=="3" (setx prompt "$T $B $P$g " & goto en-menu)
if "%preset%"=="4" (setx prompt "$P» " & goto en-menu)
if "%preset%"=="5" (goto en-menu)
cls
